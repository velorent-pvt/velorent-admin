create or replace function public.get_payment_analytics_customer_attempts(
...
begin
  ...
  select
    ...
    count(distinct qualified.payment_attempt_id)::bigint as attempt_count
  from qualified
...
revoke all on function public.get_payment_analytics_customer_attempts(
  timestamptz, timestamptz, text
) from public, anon;
grant execute on function public.get_payment_analytics_customer_attempts(
  timestamptz, timestamptz, text
) to authenticated;
